                                ...
                                <form class="user" method= "POST" action="{{ route('user.update', $user->id) }}">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="control-label" for="content"><b>Username</b></label>
                                            <input cols="30" rows="10" type="text" name="name" class = "form-control" value = "{{ $user->name }}"></input>
                                        </div>
                                        <div class="mb-3 form-group">
                                            <label class="control-label" for="content"><b>Email</b></label>
                                            <input cols="30" rows="10" type="text" name="email" class = "form-control" value = "{{ $user->email }}"></input>
                                        </div>
                                        <div class="mb-3 form-group">
