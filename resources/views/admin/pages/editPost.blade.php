                                ...
                                <form class="user" method= "POST" action="{{ route('post.update', $post->id) }}">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3 form-group">
                                            ...
                                            <input cols="30" type="text" name="title" class = "form-control" value = "{{ $post->title }}">
                                        </div>
                                        <div class="mb-3 form-group">
                                            <label class="control-label" for="content"><b>Content</b></label>
                                            <input cols="30" rows="10" type="text" name="body" class = "form-control" value = "{{ $post->body }}"></input>
                                        </div>
